...
public class AuthenticationController {
    ...
    public String registerAccount(@ModelAttribute("account") Account account, @RequestParam String rptPassword, RedirectAttributes redirectAttributes, HttpSession session) {
        ...
        if (account.getPassword().length() < MIN_LENGTH_PASSWORD || account.getPassword().length() > MAX_LENGTH_PASSWORD) {
