                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-3 d-flex">
                            <div class="card invoices-grid-card w-100">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <a href="view-invoice.html" class="invoice-grid-link">${exercise.name}</a>
                                    <a href="edit-invoice.html"><i class="far fa-edit me-2"></i>Edit</a>
                                </div>
                                <div class="container position-relative">
                                    <a href="profile.html" class="text-decoration-none text-dark d-block position-relative">
                                        ...
                                        <div class="position-absolute top-0 end-0">
                                            <h2 class="m-100 p-1 bg-info text-white rounded small" style="font-size: 15px;">
                                                    ${exercise.type}
                                            </h2>
                                            ...
                                            <h2 class="m-100 p-1 ${backgroundColor} text-white rounded small" style="font-size: 15px;">
                                                    ${exercise.level}
                                            </h2>
                                        </div>
                                    </a>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col d-flex">
                                            ...
                                            <h6 class="mb-0 ml-2">
                                                    ${exercise.caloriesOutput} calo/rep
                                            </h6>
                                        </div>
                                    </div>
                                </div>
