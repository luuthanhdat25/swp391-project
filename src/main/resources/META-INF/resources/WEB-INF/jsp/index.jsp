    ...
    <div class="page-wrapper">
            ...
            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block img-fluid" src="/theme2/img/hero-1.jpg" alt="First slide">
                        <div class="col-lg-12">
                            <div class="hero-text">
                                <h2>Gym On</h2>
                    ...
                    <div class="carousel-item">
                        <img class="d-block img-fluid" src="/theme2/img/hero-2.jpg" alt="Second slide">
                        <div class="col-lg-12">
                            <div class="hero-text">
                                <h2>Gym On</h2>
                                <h1>FITNESS & NUTRITION</h1>
                    ...
                    <div class="carousel-item">
                        <img class="d-block img-fluid" src="/theme2/img/hero-3.jpg" alt="Third slide">
                        <div class="col-lg-12">
                            <div class="hero-text">
                                <h2>Gym On</h2>
                                <h1>FITNESS & NUTRITION</h1>
        ...
        <section class="feature-section">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-4">
                        <div style="background-image: url(/theme2/img/feature-1.jpg);" class="feature-item set-bg"
                             data-setbg="/theme2/img/feature-1.jpg">
                    ...
                    <div class="col-md-4">
                        <div style="background-image: url(/theme2/img/feature-2.jpg);" class="feature-item set-bg"
                             data-setbg="//theme2/img/feature-2.jpg">
                    ...
                    <div class="col-md-4">
                        <div style="background-image: url(/theme2/img/feature-3.jpg);" class="feature-item set-bg"
                             data-setbg="/theme2/img/feature-3.jpg">
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-6">
                        <div class="choose-item">
                            <img src="/theme2/img/chose-icon-1.png" alt="">
                            <h5>Support 24/24</h5>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="choose-item">
                            <img src="/theme2/img/chose-icon-2.png" alt="">
                            <h5>Our trainer</h5>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="choose-item">
                            <img src="/theme2/img/chose-icon-3.png" alt="">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="choose-item">
                            <img src="/theme2/img/chose-icon-4.png" alt="">
                            <h5>Our equipment</h5>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="choose-item">
                            <img src="/theme2/img/chose-icon-5.png" alt="">
                            <h5>Classes daily</h5>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="choose-item">
                            <img src="/theme2/img/chose-icon-6.png" alt="">
        ...
        <section class="classes-section">
            <div style="background-image: url(/theme2/img/classes-title-bg.jpg);" class="class-title set-bg">
                <div class="container">
                    <div class="row">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div style="background-image: url(/theme2/img/class-1.jpg);" class="classes-item set-bg">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div style="background-image: url(/theme2/img/class-2.jpg);" class="classes-item set-bg">
                            <h4>BootCamp</h4>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div style="background-image: url(/theme2/img/class-3.jpg);" class="classes-item set-bg">
                            <h4>Energy Blast</h4>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div style="background-image: url(/theme2/img/class-4.jpg);" class="classes-item set-bg">
