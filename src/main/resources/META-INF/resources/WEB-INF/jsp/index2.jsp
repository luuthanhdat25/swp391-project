...
<head>
    ...
    <!-- Css Styles -->
    <link rel="stylesheet" href="../../theme1/css/bootstrap.min.css" type="text/css">
    <link rel="stylesheet" href="../../theme1/css/font-awesome.min.css" type="text/css">
    <link rel="stylesheet" href="../../theme1/css/elegant-icons.css" type="text/css">
    <link rel="stylesheet" href="../../theme1/css/nice-select.css" type="text/css">
    <link rel="stylesheet" href="../../theme1/css/owl.carousel.min.css" type="text/css">
    <link rel="stylesheet" href="../../theme1/css/magnific-popup.css" type="text/css">
    <link rel="stylesheet" href="../../theme1/css/slicknav.min.css" type="text/css">
    <link rel="stylesheet" href="../../theme1/css/style.css" type="text/css">
</head>
...
<body>
    ...
    <header class="header-section">
        <div class="container-fluid">
            <div class="logo">
                <a href="./index.html">
                    <img src="../../theme1/img/logo.png" alt="">
                </a>
            </div>
                ...
                <div class="nav-menu">
                    <nav class="mainmenu mobile-menu">
                        <ul>
                            ...
                            <li><a href="./schedule.html">Nutrition</a></li>
                            <li><a href="./gallery.html">Persional Trainer</a></li>
...
<%--                            <li><a href="./personal-trainer/profile">Profile</a></li>--%>
                        </ul>
                    </nav>
                </div>
            </div>
    ...
    <section class="hero-section">
        <div class="hero-items owl-carousel">
            <div class="single-hero-item set-bg" data-setbg="../../theme1/img/hero-slider/hero-1.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero-text">
            ...
            <div class="single-hero-item set-bg" data-setbg="../../theme1/img/hero-slider/hero-2.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero-text">
            ...
            <div class="single-hero-item set-bg" data-setbg="../../theme1/img/hero-slider/hero-3.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero-text">
    ...
    <section class="feature-section">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4">
                    <div class="feature-item set-bg" data-setbg="../../theme1/img/feature/feature-1.jpg">
                        <h3>GROUP CLASSES</h3>
                ...
                <div class="col-md-4">
                    <div class="feature-item set-bg" data-setbg="../../theme1/img/feature/feature-2.jpg">
                ...
                <div class="col-md-4">
                    <div class="feature-item set-bg" data-setbg="../../theme1/img/feature/feature-3.jpg">
    ...
    <section class="home-about spad">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about-img">
                        <img src="../../theme1/img/home-about.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="classes-item set-bg" data-setbg="../../theme1/img/classes/class-1.jpg">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="classes-item set-bg" data-setbg="../../theme1/img/classes/class-2.jpg">
                        <h4>BootCamp</h4>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="classes-item set-bg" data-setbg="../../theme1/img/classes/class-3.jpg">
                        <h4>Energy Blast</h4>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="classes-item set-bg" data-setbg="../../theme1/img/classes/class-4.jpg">
    ...
    <section class="price-section spad set-bg" data-setbg="../../theme1/img/price-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        <img src="../../theme1/img/icons/chose-icon-1.png" alt="">
                        <h5>Support 24/24</h5>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        <img src="../../theme1/img/icons/chose-icon-2.png" alt="">
                        <h5>Our trainer</h5>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        <img src="../../theme1/img/icons/chose-icon-3.png" alt="">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        <img src="../../theme1/img/icons/chose-icon-4.png" alt="">
                        <h5>Our equipment</h5>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        <img src="../../theme1/img/icons/chose-icon-5.png" alt="">
                        <h5>Classes daily</h5>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="choose-item">
                        <img src="../../theme1/img/icons/chose-icon-6.png" alt="">
    ...
    <!-- Video Section Begin -->
    <section class="video-section set-bg" data-setbg="../../theme1/img/video-bg.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="video-text">
                        <h2>Gym In Dowtown New York</h2>
                        <a href="https://www.youtube.com/watch?v=2Ffyq9VSTmo" class="play-btn video-popup">
        ...
        <div class="container">
            ...
            <div class="row blog-gird">
                ...
                <div class="col-lg-4 col-md-6 grid-item">
                    <div class="blog-item large-item set-bg" data-setbg="../../theme1/img/blog/blog-1.jpg">
                ...
                <div class="col-lg-4 col-md-6 grid-item">
                    <div class="blog-item small-item set-bg" data-setbg="../../theme1/img/blog/blog-2.jpg">
                        <a href="#" class="blog-text">
                            <div class="categories">Gym & Croosfit</div>
                ...
                <div class="col-lg-4 col-md-6 grid-item">
                    <div class="blog-item large-item xls-large set-bg" data-setbg="../../theme1/img/blog/blog-3.jpg">
                        <a href="#" class="blog-text">
                            <div class="categories">Gym & Croosfit</div>
                            <h5>Many people sign up for affiliate programs</h5>
                        </a>
                ...
                <div class="col-lg-4 col-md-6 grid-item">
                    <div class="blog-item large-item set-bg" data-setbg="../../theme1/img/blog/blog-4.jpg">
                        <a href="#" class="blog-text">
                            <div class="categories">Gym & Croosfit</div>
                            <h5>Many people sign up for affiliate programs</h5>
                        </a>
                ...
                <div class="col-lg-4 col-md-6 grid-item">
                    <div class="blog-item small-item set-bg" data-setbg="../../theme1/img/blog/blog-5.jpg">
                        <a href="#" class="blog-text">
                            <div class="categories">Gym & Croosfit</div>
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --> </div>
    ...
    <script src="../../theme1/js/mixitup.min.js"></script>
    <script src="../../theme1/js/jquery.nice-select.min.js"></script>
    <script src="../../theme1/js/jquery.slicknav.js"></script>
    <script src="../../theme1/js/owl.carousel.min.js"></script>
    <script src="../../theme1/js/masonry.pkgd.min.js"></script>
