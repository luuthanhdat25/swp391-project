                            ...
                            <tbody>
                                <c:forEach var="notification" items="${NotificationList.content}">
                                    <tr class="shadow p-3 mb-5 bg-body rounded" style="height: 30px;">
                                        ...
                                        <td><div class="text-truncate" style="width: 430px;">${notification.title}</div></td>
                                        <td>
                                            <img class="rounded-circle" style="width: 35px;" src="https://png.pngtree.com/png-vector/20190710/ourlarge/pngtree-user-vector-avatar-png-image_1541962.jpg"/>
                                        </td>
                                        <td class="d-flex"
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-between" style="width: 210px;">
                                                 <form action="view-notification-detail" method="get">
                                                     ...
                                                     <button type="submit" class="btn btn-info" style="height: 40px; width: 90px; color: #FFFFFF;">
                                                ...
                                                <form action="delete-notification-detail" method="get">
                                                    ...
                                                    <button type="submit" class="btn btn-danger" style="height: 40px; width: 110px;">
                        ...
                        <nav aria-label="Page navigation example" style = "height: 20px; margin: 20px 0 20px 0;">
                           <ul class="pagination justify-content-center ">
                             ...
                             <li class="page-item <%= currentPage - 1 < 1 ? "disabled" : "" %>">
                                <a class="page-link" href="manage-notification?papeNo=<%=currentPage - 1%>">Previous</a>
                             </li>
                             <% for (int i = currentPage; i <= Math.min(totalPage, currentPage + 3); i++) { %>
                                <li class="page-item <%= i == currentPage ? "disabled" : "" %>">
                                   <a class="page-link" href="manage-notification?papeNo=<%=i%>"><%=i%></a>
                                </li>
                             <% } %>
                             <li class="page-item <%= currentPage + 1 > totalPage ? "disabled" : "" %>">
                                <a class="page-link" href="manage-notification?papeNo=<%=currentPage + 1%>">Next</a>
                             </li>
                           </ul>
                        </nav>
