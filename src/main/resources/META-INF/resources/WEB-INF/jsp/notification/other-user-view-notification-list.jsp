               ...
               <ul id="sidebar-menu" class="sidebar-menu" style="padding: 2px 9px 9px 9px;">
                   ...
                   <c:forEach var="notification" items="${NotificationList}">
                        <li style="margin-bottom: 4px;" >
                            ...
                            <form id="notificationForm${notification.id}" action="view-notification-list" method="GET" style="display: none;">
                                <input type="hidden" name="notificationId" value="${notification.id}" />
                            </form>

                            <a onclick="submitNotificationForm(${notification.id});"
                            style="background-color: ${notification.id == NotificationDetail.id ? '#d9d9d9' : '#FFFFFF'};" class="input-container">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="d-flex flex-column justify-content-start" style="margin-left: 5px;">
                                            ...
                                            <p class="text-truncate" style="margin-top: 2px; margin-bottom: 0px; color: #797979; font-size: 12px; max-width: 250px;">${notification.title}</p>
                                        </div>
                                    </div>
