                ...
                <div class="modal-body" style="background-color: #e6e6e6;">
                    <div class="d-flex flex-column" style="width: 100%; margin-top: 3px;">
                        ...
                        <div class="shadow mb-5 bg-body rounded d-flex flex-column  align-items-center"
                            ...
                            <div>
                                <p><strong>Approval Request:</strong></p>
                                <p>A personal trainer has just registered into the system and submitted certificates,
                                    please review and approve his/her account to officially operate on the website.</p>
                            </div>

                            <p style="margin-top: 10px;"><strong>Certificate 1</strong></p>
                            <img id="cerificate_1" alt="Certificate" style="width: 90%; height: auto;">
                            <p style="margin-top: 10px;"><strong>Certificate 2</strong></p>
                            <img id="cerificate_2" alt="Certificate" style="width: 90%; height: auto;">
                            <p style="margin-top: 10px;"><strong>Certificate 3</strong></p>
                            <img id="cerificate_3" alt="Certificate" style="width: 90%; height: auto;">
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function showModal(detail) {
        ...
        $('#cerificate_1').attr('src', 'data:image/jpeg;base64,' + detail.cerificate_1);
        $('#cerificate_2').attr('src', 'data:image/jpeg;base64,' + detail.cerificate_2);
        $('#cerificate_3').attr('src', 'data:image/jpeg;base64,' + detail.cerificate_3);
        ...
        if (requestStatus === "PENDING") {
            ...
            <div class="d-flex justify-content-between align-content-center">
                <form action="reject-personal-trainer-request" method="get">
                    <input type="hidden" name="requestID" class ="requestID">
        ...
        `
            const requestIDInputs = buttonGroup.querySelectorAll('.requestID');
