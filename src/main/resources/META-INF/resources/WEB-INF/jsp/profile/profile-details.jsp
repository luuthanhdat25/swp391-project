            ...
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li style="margin-bottom: 4px;" class="shadow bg-body rounded">
                        <a href="${pageContext.request.contextPath}/admin-home/manage-notification"
                           style="text-decoration: none;" onclick="">
                    ...
                    <li style="margin-bottom: 4px;" class="shadow bg-body rounded">
                        <a href="${pageContext.request.contextPath}/admin-home/manage-report"
                           style="text-decoration: none;" onclick="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                    ...
                    <li style="margin-bottom: 4px;" class="shadow bg-body rounded">
                        <a href="${pageContext.request.contextPath}/admin-home/manage-personal-trainer-request"
                           style="text-decoration: none;" onclick="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                    ...
                    <li style="margin-bottom: 4px;" class="shadow bg-body round ed">
                        <a href="${pageContext.request.contextPath}/admin-home/manage-account"
                           style="text-decoration: none;" onclick="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor"
                    ...
                    <li style="margin-bottom: 4px;" class="shadow bg-body rounded">
                        <a href="${pageContext.request.contextPath}/admin-home/manage-exercise"
                           style="text-decoration: none;" onclick="">
                            <i class="fas fa-dumbbell" style="margin-right: 5px;"></i>
                            Manage Exercise</a>
                    </li>
                    <li style="margin-bottom: 4px;" class="shadow bg-body rounded">
                        <a href="${pageContext.request.contextPath}/admin-home/manage-nutrition"
                           style="text-decoration: none;" onclick="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-2 col-md-2" style="display: flex;align-items: center;">
                                        <c:if test="${accountView.getIsBan() == 'false'}">
                                            <a href="/admin-home/lock-account?id=${accountView.getId()}"
                                               style="width: 100%;height: 48px;line-height: 36px"
                                               class="btn btn-primary lock-account">Lock Account</a>
                                        </c:if>
                                        <c:if test="${accountView.getIsBan() == 'true'}">
                                            <a href="/admin-home/unlock-account?id=${accountView.getId()}"
                                               style="width: 100%;height: 48px;line-height: 36px"
                                               class="btn btn-primary unlock-account">Unlock Account</a>
                                        </c:if>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#send-button').click(function (event) {
            ...
            var receiverID = gymerAccount.id;
            $.ajax({
                type: 'GET',
