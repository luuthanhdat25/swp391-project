...
<html>
	...
	<body>
		<div class="d-flex justify-content-center">
              ...
              <div class="modal fade" id="viewReportDetail" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered" style = "width: 630px;">
                  <div class="modal-content" >
			...
			<div style = "width: 50%; height: 430px; padding: 10px; margin-top: 100px;" class = "border border-dark">
                <button type="submit" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal">Add Report</button>
                ...
                <div style = "height: 310px;">
                       <c:forEach items = "${Reports.content}" var = "report">
                             <a href="view-report-list-and-detail?reportId=${report.getId()}&papeNo=${CurrentPage}" style="text-decoration: none; color: inherit;">
                                   <div class="d-flex flex-row bd-highlight justify-content-between border border-dark" style = "padding: 5px; margin-top: 10px;">
                                            <div class="d-flex flex-row bd-highlight justify-content-between align-items-center">
                                                 ...
                                                 <label class="d-inline-block text-truncate" style="max-width: 300px; height: 27px; margin-left: 10px;">
                                                  ${report.getTitle()}
                                                 </label>
                                            </div>
                                            <div  class="d-flex flex-row bd-highlight justify-content-between align-items-center">
