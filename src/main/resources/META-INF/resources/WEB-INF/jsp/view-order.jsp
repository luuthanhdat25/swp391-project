                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <c:forEach var="order" items="${OrderRequestList}">
                                        <tr>
                                            ...
                                            <td>
                                                <c:if test="${order.getStatusString() == 'Pending'}">
                                                    <span class="status text-danger">&bull; pending</span>
                                                </c:if>
                                                <c:if test="${order.getStatusString() == 'OnDoing'}">
                                                    <span class="status text-info">&bull; on going</span>
                                                </c:if>
                                                <c:if test="${order.getStatusString() == 'Expire'}">
                                                    <span class="status text-warning">&bull;</span>
                                                    <span>Expired</span>
                                                </c:if>
                                                <c:if test="${order.getStatusString() == null}">
                                                    <span class="status text-warning">&bull;</span>
                                                    <span>Waiting</span>
                                                </c:if>
                                            </td>
